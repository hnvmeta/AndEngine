...
public class TextureMovieEncoder2 implements Runnable {
    public interface OnMovieEncodeListener {
        void onStopMovieEncoder(File outFile);
    }
    ...
    private OnMovieEncodeListener onMovieEncodeListener;
    ...
    public void setOnMovieEncodeListener(OnMovieEncodeListener onMovieEncodeListener) {
    ...
    private void handleStopRecording() {
        ...
        if (onMovieEncodeListener != null) {
            if (mVideoEncoder != null) {
                onMovieEncodeListener.onStopMovieEncoder(mVideoEncoder.getOutFile());
            } else {
