...
import org.andengine.grafika.gles.Drawable2d;
import org.andengine.grafika.gles.EglCore;
import org.andengine.grafika.gles.FlatShadedProgram;
import org.andengine.grafika.gles.FullFrameRect;
import org.andengine.grafika.gles.GlUtil;
import org.andengine.grafika.gles.Sprite2d;
...
public class RecordFBOActivity extends BaseActivity implements SurfaceHolder.Callback,
    ...
    public void safeRunOnUI(Runnable r) {
...
//        sv.getHolder().addCallback(this);
    ...
    public void setRenderer(final Engine pEngine, final IRendererListener pRendererListener) {
        ...
        if (mRenderThread != null) {
            mRenderThread.setRenderer(pEngine, pRendererListener);
        }
    }
    ...
    public void surfaceCreated(SurfaceHolder holder) {
        ...
        File outputFile = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_MOVIES), "Grafika/fbo-gl-recording-" + System.currentTimeMillis() + ".mp4");//new File(getFilesDir(), "fbo-gl-recording.mp4");
        ...
        setRenderer(mEngine, mIRendererListener);
